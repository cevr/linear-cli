...
import { TokenNotFoundError } from "./lib/errors.js"
...
cli(process.argv).pipe(
  Effect.catchTag("TokenNotFoundError", (e) =>
    Console.error(`Error: ${e.message}`)
  ),
  Effect.catchTag("LinearApiError", (e) =>
    Console.error(`Linear API Error: ${e.message}`)
  ),
